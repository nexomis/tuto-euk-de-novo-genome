...
We have selected [PRJNA721899](https://www.ebi.ac.uk/ena/browser/view/PRJNA721899) in which 6 differently virulent strains of *Fusarium oxysporum* f. sp. *lini* were sequenced using both Illumina (short-read) and Oxford Nanopore (long-read) technologies. This dual-platform approach provides complementary data types ideal for hybrid genome assembly.
