...
**Memory errors**: Reduce hash table size (`-H` parameter) or use smaller k-mer sizes first
**Missing genome size estimates**: Check KAT output files for errors or warnings
**Inconsistent estimates**: May indicate contamination or highly heterozygous regions
**R visualization errors**: Ensure all required packages are installed:
